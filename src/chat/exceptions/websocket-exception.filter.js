...
var WebsocketExceptionFilter = /** @class */ (function () {
    function WebsocketExceptionFilter() {
    }
    WebsocketExceptionFilter.prototype["catch"] = function (exception, host) {
        var socket = host.switchToWs().getClient();
